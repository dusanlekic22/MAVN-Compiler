...
private:
	 ...
	 */
	static const TokenType m_stateToTokenTable[NUM_STATES];

	/**
	 * Array contaning supported characters
	 */
	static const char m_supportedCharacters[NUM_OF_CHARACTERS];
	 ...
	 */
	static const int m_stateMatrix[NUM_STATES][NUM_OF_CHARACTERS];
};
